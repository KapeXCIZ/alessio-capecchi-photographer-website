    ...
    return (
        <>
            ...
            <div className="container md:no-container flex w-full h-14 bg-transparent backdrop-blur-md sticky z-50 top-0 px-10 gap-3 items-center justify-between serif">
                <Link to={'/gallery'} className="flex flex-row items-center gap-1"><Aperture size={28} weight="regular" className="hover:rotate-180 transition duration-500 ease-in-out" />Gallery</Link>
                ...
                <p id="email" className="hover:cursor-pointer hover:drop-shadow-[0_0_10px_gray] hidden md:block trasition duration-500" onClick={copyContent}>alessiocapecchiphoto@gmail.com</p>
            </div>
        </>
    )
}